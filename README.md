...
### ✨ Features
- **3 imposter modes:** Classic (imposter knows nothing), Hint (the imposter gets a clue of **at most three words** — Zebra is "black and white", Titanic is "long cold night": enough to bluff with, never enough to know), and **Decoy** — the imposter gets a similar-but-wrong word and doesn't even know they're the imposter!
